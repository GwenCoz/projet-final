        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md='3' lg='4' xl='3' className='mx-auto mb-4'>
              ...
              <p>
              <a href="#!" className="text-reset">Conditions de culture</a>
            </p>

            <p>
              <a href="#!" className="text-reset">Leur origine</a>
            </p>

            <p>
              <a href="#!" className="text-reset">Notre Amour</a>
            </p>
            <p>
              <a href="#!" className="text-reset">Parrainer</a>
            </p>
            </MDBCol>

            <MDBCol md='4' lg='3' xl='3' className='mx-auto mb-md-0 mb-4'>
              <h6 className='text-uppercase fw-bold mb-4'style={{color: "green"}}>Contact</h6>
              <p>
                <MDBIcon color='secondary' icon='home' />
                Adresse postale: Rouen, France
              </p>
              <p>
                <MDBIcon color='secondary' icon='envelope' className='me' />
                Email: email@ajc-flowers.com
              </p>
              <p>
                <MDBIcon color='secondary' icon='print'  /> Telephone: +0033 1 234 567 89
              </p>
            </MDBCol>
            

            <MDBCol md='3' lg='2' xl='2' className='mx-auto mb-4' style={{color: "green"}}>
              <h6 className='text-uppercase fw-bold mb-4'>SUIVEZ-NOUS</h6>
              <a href="" className="me-4">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
