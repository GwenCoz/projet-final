...
function Body(){
    return (
        ...
        <div  style={{margin:"0 40px",width:"400px",height:"400px",position: "relative", display:"flex", "justifyContent":"center"}}>
            ...
            <button onClick={()=>window.location.href=('nos_plantes_interieur')} id="btn_submit" style={{position:"absolute",bottom:"20px"}}> Plantes d'intérieur</button> 
        </div>
        ...
        <div  style={{margin:"0 40px", width:"400px",height:"400px",position: "relative", display:"flex", "justifyContent":"center"}}>
            ...
            <button onClick={()=>window.location.href=('nos_plantes_exterieur')} id="btn_submit" style={{position:"absolute",bottom:"20px"}}> Plantes d'extérieur</button> 
        </div>
        </div>   
